...
export default function OperatorStudioError({
  error,
  reset,
}: {
  ...
  return (
    <div className="flex min-h-[60vh] flex-col items-center justify-center gap-6 text-center">
      ...
      <div>
        <h2 className="text-xl font-bold text-[hsl(var(--foreground))]">Operator Studio failed to load</h2>
