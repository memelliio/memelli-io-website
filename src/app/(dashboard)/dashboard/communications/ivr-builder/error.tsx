...
export default function IvrBuilderError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    console.error('[IVR Builder Error]', error);
  }, [error]);
  ...
  return (
    <div className="flex min-h-[60vh] flex-col items-center justify-center gap-6 text-center p-8">
      ...
      <div>
        <h2 className="text-xl font-semibold text-zinc-100">Failed to load IVR builder</h2>
