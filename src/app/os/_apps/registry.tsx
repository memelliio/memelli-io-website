...
export const APPS: AppDef[] = [
  ...
  { id: "credit-reports", label: "Credit Reports", icon: `${I}/credit-reports.png`, category: "business", modes: ["business"], singleton: true, defaultSize: { w: 1000, h: 720 }, body: { kind: "component", Component: CreditReports } },
  { id: "credit", label: "Credit", icon: `${I}/credit-reports.png`, category: "business", modes: ["personal", "business"], singleton: true, defaultSize: { w: 880, h: 640 }, body: { kind: "component", Component: Credit } },
  { id: "crm", label: "CRM", icon: `${I}/relationships.png`, category: "business", modes: ["business"], badge: 28, singleton: true, defaultSize: { w: 1280, h: 760 }, body: { kind: "component", Component: CRMAdmin } },
  ...
  { id: "storefront", label: "Storefront", icon: `${I}/storefront.png`, category: "business", modes: ["business"], singleton: true, defaultSize: { w: 1280, h: 760 }, body: { kind: "component", Component: CommerceAdmin } },
  ...
  { id: "docuvault", label: "DocuVault", icon: `${I}/files.png`, category: "business", modes: ["business"], singleton: true, defaultSize: { w: 1000, h: 700 }, body: { kind: "component", Component: DocuVault } },
  ...
  { id: "partners", label: "Partners", icon: `${I}/relationships.png`, category: "business", modes: ["business"], singleton: true, defaultSize: { w: 1100, h: 760 }, body: { kind: "component", Component: PartnersHub } },

  // ── COMMUNICATIONS (6) ─────────────────────────────────────────
  { id: "phone", label: "Phone", icon: `/api/os-icon/static-phone.png`, category: "communications", modes: ["business"], defaultSize: { w: 420, h: 600 }, body: { kind: "stub", title: "Phone", blurb: "Outbound + inbound." } },
  ...
  { id: "messages", label: "Messages", icon: `/api/os-icon/static-message.png`, category: "communications", modes: ["business"], badge: 7, defaultSize: { w: 720, h: 500 }, body: { kind: "stub", title: "Messages", blurb: "SMS + chat threads." } },
  ...
  { id: "welcome", label: "Welcome", icon: `${I}/memelli-chat.png`, category: "hidden", singleton: true, defaultSize: { w: 720, h: 500 }, body: { kind: "component", Component: Welcome } },
  { id: "settings", label: "Settings", icon: `${I}/workflow-builder.png`, category: "hidden", singleton: true, defaultSize: { w: 720, h: 480 }, body: { kind: "component", Component: Settings } },
  { id: "browser", label: "Browser", icon: `${I}/seo.png`, category: "hidden", defaultSize: { w: 980, h: 640 }, body: { kind: "component", Component: Browser } },
  { id: "calculator", label: "Calculator", icon: `${I}/billing.png`, category: "hidden", defaultSize: { w: 320, h: 460 }, body: { kind: "component", Component: Calculator } },
  { id: "terminal", label: "Terminal", icon: `${I}/code.png`, category: "hidden", defaultSize: { w: 680, h: 420 }, body: { kind: "component", Component: Terminal } },
  { id: "clock", label: "Clock", icon: `${I}/calendar.png`, category: "hidden", singleton: true, defaultSize: { w: 480, h: 280 }, body: { kind: "component", Component: Clock } },
  { id: "files", label: "Files", icon: `${I}/files.png`, category: "hidden", defaultSize: { w: 640, h: 460 }, body: { kind: "component", Component: Files } },
  { id: "memelli-bar-settings", label: "Bar Settings", icon: `${I}/workflow-builder.png`, category: "hidden", singleton: true, defaultSize: { w: 520, h: 640 }, body: { kind: "component", Component: MelliBarSettings } },
  { id: "signup", label: "Sign Up", icon: `${I}/sign-up.png`, category: "hidden", singleton: true, defaultSize: { w: 760, h: 640 }, body: { kind: "component", Component: SignUp } },
  { id: "client-workspace", label: "CRM Workspace", icon: `${I}/relationships.png`, category: "hidden", defaultSize: { w: 980, h: 660 }, body: { kind: "component", Component: ClientWorkspace } },
];
